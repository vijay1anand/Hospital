 ...
 <div class="modal fade" id="myModal" role="dialog">
      ...
      <!-- Modal content-->
                                ...
                                <div class="form-group">
                                         ...
                                         <input type="email" class="form-control" id="email" value="<?php echo $email ;?>" placeholder="Enter email" name="email"  readonly>
                                 </div>
                                <div class="form-group">
                                        <label for="Name">Name</label>
                                       <input type="text" class="form-control" id="name" value="<?php echo $username ;?>" placeholder="Enter Name" name="uname">
                                </div>
                                <div class="form-group">
                                        <label for="pn">Phone Number:</label>
                                       <input type="Number" class="form-control" id="phone" value="<?php echo $phoneno ;?>"placeholder="Enter Phone Number" name="pnum">
                                </div>
                                                <div class="form-group">
                                ...
                                <div class="form-group" id="ifCSV" style="display:none">
                                       ...
                                       <input type="textarea" class="form-control" id="pwd" value="<?php echo $dest_address ;?>" placeholder="Enter Address" name="dst">
                                </div>
                                 <div class="form-group">
                                        <label for="land"  id="ifCS" style="display:none">landmark:</label>
