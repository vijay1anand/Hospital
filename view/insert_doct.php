...
<a href="camp.php"><li>Free Dental Checkup on  28<sup>th</sup> December</li></a>
    ...
    <div class="col-sm-6 text-left">
      ...
      <hr>
      <form name="doctor_info" action="../controller.php" method="post">
<tr><td><label><b>Name</b></label></td>
<td><input type="text" name="drname" value="<?php echo $name;?>" required></input></td>

</tr><br/><br/>
<tr><td><label><b>Spcialisation</b></label>
<td><input type="text" name="speci"  value="<?php echo $sp?>" required></td></tr><tr>

</tr><br/><br/>
<tr><td><label><b>Degree</b></label></td>
<td><input type="text" name="avail" value="<?php echo $degree?>" required></td></tr><tr></tr><tr>

</tr>
</tr><br/><br/>
<tr><td><label><b>Joining Date</b></label></td>
<td><input type=date name="jdate" value="<?php echo $date?>" required></td></tr>

</tr><br/><br/>
    <tr><td><input type="hidden" id="activity" name="activity" value="add_doctor"><button type="submit" name="submit" id="submit" value="submit">Submit</button></td></tr>
